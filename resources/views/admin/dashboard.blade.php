                        ...
                        <div class="card-header">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-custom">
                                    <li>
                                        <a class="dropdown-item" href="#"><i class="bi bi-arrow-repeat"></i> Refresh</a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="#"
                                            ><i class="bi bi-file-earmark-arrow-down"></i> Export Report</a
                                        >
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a class="dropdown-item text-danger" href="#"
                                            ><i class="bi bi-eye-slash"></i> Hide Details</a
                                        >
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="card-header">
                        ...
                        <div class="dropdown">
                            <button
                                ...
                                aria-expanded="false"
                                aria-label="More Options"
                                id="btn-more-transaction"
                            >
                                <i class="bi bi-three-dots"></i>
                            </button>
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-custom">
                                <li>
                                    <a class="dropdown-item" href="#"><i class="bi bi-funnel"></i> Filter Status</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="#"
                                        ><i class="bi bi-file-earmark-arrow-down"></i> Export CSV</a
                                    >
                                </li>
                            </ul>
                        </div>
                ...
                <div class="card h-100 flex-grow-1">
                    <div class="card-header">
                        ...
                        <div class="dropdown">
                            <button
                                ...
                                aria-expanded="false"
                                aria-label="More Options"
                                id="btn-more-products"
                            >
                                <i class="bi bi-three-dots"></i>
                            </button>
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-custom">
                                <li>
                                    <a class="dropdown-item" href="#"><i class="bi bi-plus-lg"></i> Add Product</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="#"><i class="bi bi-gear"></i> Manage</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="progress-container">
                        ...
                        <div
                            class="progress"
                            role="progressbar"
                            aria-label="Product Launched Progress"
                            aria-valuenow="65"
                            aria-valuemin="0"
                            aria-valuemax="100"
                        >
                    ...
                    <div class="progress-container">
                        ...
                        <div
                            class="progress"
                            role="progressbar"
                            aria-label="Ongoing Product Progress"
                            aria-valuenow="20"
                            aria-valuemin="0"
                            aria-valuemax="100"
                        >
                    ...
                    <div class="progress-container">
                        ...
                        <div
                            class="progress"
                            role="progressbar"
                            aria-label="Product Sold Progress"
                            aria-valuenow="85"
                            aria-valuemin="0"
                            aria-valuemax="100"
                        >
                    ...
                    <div class="progress-container">
                        ...
                        <div
                            class="progress"
                            role="progressbar"
                            aria-label="Product Returned Progress"
                            aria-valuenow="10"
                            aria-valuemin="0"
                            aria-valuemax="100"
                        >
                    ...
                    <div class="progress-container">
                        ...
                        <div
                            class="progress"
                            role="progressbar"
                            aria-label="Product In Stock Progress"
                            aria-valuenow="75"
                            aria-valuemin="0"
                            aria-valuemax="100"
                        >
                    ...
                    <div class="progress-container">
                        ...
                        <div
                            class="progress"
                            role="progressbar"
                            aria-label="Pending Shipment Progress"
                            aria-valuenow="45"
                            aria-valuemin="0"
                            aria-valuemax="100"
                        >
